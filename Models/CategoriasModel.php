...
class CategoriasModel extends Mysql
{
    ...
    public function selectCategoria(int $idcategoria)
    {
        ...
        $sql = "SELECT  idcategoria,nombre,descripcion,portada,status FROM categoria WHERE idcategoria =$this->intIdcategoria";
    ...
    public function insertCategoria(string $categoria, string $descripcion, string $img, int $status)
    {
        ...
        if (empty($request)) {
            ...
            $arrData = array($this->strCategoria, $this->strDescripcion,$this->strImagen, $this->intStatus);
