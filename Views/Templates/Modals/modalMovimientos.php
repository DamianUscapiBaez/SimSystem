...
<div class="modal fade" id="modalProducto" tabindex="-1" role="dialog" aria-hidden="true">
  <div class="modal-dialog modal-md">
    <div class="modal-content">
      <div class="modal-header header-primary">
        <h5 class="modal-title" id="titleModal">Buscar producto</h5>
        <button type="button" class="close" data-dismiss="modal" onclick="closeModalproducto();" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      <div class="modal-body">
        <form id="buscar_producto">
          <p>Ingresar codigo o nombre del producto</p>
          <div class="row">
            <div class="col-md-12 text-center">
              <input name="search_producto" id="search_producto" type="text" class="form-control">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form id="buscar_cliente">
          <p>Ingresar Ruc, Dni o nombre del proveedor</p>
          <div class="row">
            <div class="col-md-12 text-center">
...
<div class="modal fade" id="modalFormProveedor" tabindex="-1" role="dialog" aria-labelledby="modalFormRolLabel" aria-hidden="true">
      ...
      <div class="modal-body">
        <form class="needs-validation" id="formProveedor" name="formProveedor">
          ...
          <div class="position-relative form-group">
            ...
            <input name="txtRuc" id="txtRuc" placeholder="Ejem. 10098398343" type="text" class="form-control" maxlength="11" required>
          </div>
          <div class="position-relative form-group">
            <label for="exampleText" class="">nombre</label>
            <input name="txtNombre" id="txtNombre" placeholder="Ejem. System Tecnology" type="text" class="form-control" required>
          </div>
          <div class="row">
            <div class="col-md-6">
              <div class="position-relative form-group">
                <label for="exampleText" class="">Direccion</label>
                <input name="txtDireccion" id="txtDireccion" placeholder="Ejem. Calle peral N° 897" type="text" class="form-control" required>
              </div>
            </div>
            <div class="col-md-6">
              <div class="position-relative form-group">
                <label for="exampleText" class="">telefono</label>
                <input name="txtTelefono" id="txtTelefono" placeholder="Ejem. 999 999 999" type="text" class="form-control" maxlength="9" required>
              </div>
            </div>
          </div>
          <div class="position-relative form-group">
